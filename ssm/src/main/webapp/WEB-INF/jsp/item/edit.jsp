        ...
        <div class="container" style="border:1px solid black">
            ...
            <form action="editItem.action" role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="i_name" name="i_name" value="${item.i_name}" placeholder="请输入商品名称">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="i_price" name="i_price" value="${item.i_price}" placeholder="请输入商品价格">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" id="i_describe" name="i_describe" value="${item.i_describe}" placeholder="请输入商品描述">
                    </div>
                </div>
